...
<div>
    <form wire:submit="resetPassword">
        <!-- Email Address -->
        <div>
            <flux:label for="email" :value="__('Email')" />
            ...
            <flux:error :messages="$errors->get('email')" class="mt-2" />
        </div>
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <flux:label for="password_confirmation" :value="__('Confirm Password')" />

            <flux:input wire:model="password_confirmation" id="password_confirmation" class="block mt-1 w-full"
                          type="password"
                          name="password_confirmation" required autocomplete="new-password" />

            <flux:error :messages="$errors->get('password_confirmation')" class="mt-2" />
        </div>
