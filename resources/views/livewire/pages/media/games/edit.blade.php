                    ...
                    <div class="overflow-hidden shadow-2xs sm:rounded-lg">
                        ...
                        <flux:table :paginate="$this->games">
                            <flux:table.columns>
                                ...
                                <flux:table.column sortable :sorted="$sortBy === 'is_active'" :direction="$sortDirection" wire:click="sort('is_active')">Playing</flux:table.column>
                                ...
                                <flux:table.column sortable :sorted="$sortBy === 'is_completed'" :direction="$sortDirection" wire:click="sort('is_completed')">Played Before</flux:table.column>
